                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form" id="frmUser" method="post" action="crudUser.php?action=crear">
                            ...
                            <div class="form-group">
                                ...
                                <input id="apellidouno" name="apellidouno" class="form-control" placeholder="Ojeda Medina">
                                <p class="help-block">Primer Apellido del usuario.</p>
                            </div>

                            <div class="form-group">
                                <label>Apellido dos</label>
                                <input id="apellidodos" name="apellidodos" class="form-control" placeholder="Ojeda Medina">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">Agregue una Descripcion.</p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="webpersonal" name="webpersonal" class="form-control" placeholder="webpersonal">
